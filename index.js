...
const topnumUnfunded = GAMES_JSON.reduce((acc, game) => 
    acc + (game.pledged < game.goal ? 1 : 0)
    ,0);

// create a string that explains the number of unfunded games using the ternary operator
const unfundedStr = `A total of $${totalRaised.toLocaleString('en-US')} has been raised for ${totalGames} games. Currently we have ${numUnfunded} ${numUnfunded < 2 ? " unfunded game. ": "unfunded games. "}Please consider donating to our amazing games!`;

// create a new DOM element containing the template string and append it to the description container
const descriptionElement = document.createElement('p');
descriptionElement.innerText = unfundedStr;
